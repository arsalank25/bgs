...
<%
	...
	if (productList.size() != 0) {
		try {
			...
			String sql = "SELECT MAX(C.cID) AS CusID FROM Cart C LEFT JOIN Shipment S ON C.cID = S.cID WHERE S.cID IS NULL AND C.customerID = ?";
		...
		{ 
			...
			insertProduct = "INSERT INTO CartContains(cID,customerID,pID,quantity) VALUES (?, ?, ?, ?)";
